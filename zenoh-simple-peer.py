...
node_name = "zenoh-simple-peer"
zenoh_config = zenoh.Config()
zenoh_config.insert_json5("mode", json.dumps("peer"))
zenoh_config.insert_json5("listen/endpoints", json.dumps(["tcp/127.0.0.1:7447"]))
